...
import (
	...
	"github.com/cosmos/cosmos-sdk/interchaintest/helpers"
...
// TestStakeTokenizeSendVote checks that once shares are tokenized, the tokens can be
...
func TestTokenizeSendVote(t *testing.T) {
	...
	proposalTx, err := chain.TextProposal(ctx, secondUser.KeyName(), proposal)
