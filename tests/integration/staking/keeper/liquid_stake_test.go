...
func TestGetAllTokenizeSharesLocks(t *testing.T) {
	...
	addresses := simtestutil.AddTestAddrs(app.BankKeeper, app.StakingKeeper, ctx, 4, sdk.NewInt(1))
	...
	actualLocks := app.StakingKeeper.GetAllTokenizeShareLocks(ctx)
...
func TestPendingTokenizeShareAuthorizations(t *testing.T) {
	...
	addresses := simtestutil.AddTestAddrs(app.BankKeeper, app.StakingKeeper, ctx, 3, sdk.NewInt(1))
...
func TestTokenizeShareAuthorizationQueue(t *testing.T) {
	...
	//   Time 4: [address6]
	addresses := simtestutil.AddTestAddrs(app.BankKeeper, app.StakingKeeper, ctx, 7, sdk.NewInt(1))
